...
public class Dialogo_Modificar_Examen extends javax.swing.JDialog {
    ...
    public Convocatoria entidad;

    /**
     * Creates new form Dialogo_Agregar_Asignatura
     */
    public Dialogo_Modificar_Examen(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public void resetear(Estudiante e,Asignatura a,Convocatoria c) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dialogo_Modificar_Examen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Dialogo_Modificar_Examen dialog = new Dialogo_Modificar_Examen(new javax.swing.JFrame(), true);
