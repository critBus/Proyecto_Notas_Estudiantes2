...
public class Practicas1PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Practicas1";
	...
	private Practicas1PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new Practicas1PersistentManager();
		}
